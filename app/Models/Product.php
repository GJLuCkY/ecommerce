...
class Product extends Model
{
    ...
    */
    ...
    protected $fillable = ['title', 'meta_description', 'slug', 'image', 'content', 'price', 'article', 'code', 'quantity', 'api_id_product', 'api_id_category', 'status', 'custom_name', 'packaging', 'minimum', 'type'];
    // protected $hidden = [];
    // protected $dates = [];
