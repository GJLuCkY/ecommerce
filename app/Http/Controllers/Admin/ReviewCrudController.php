...
class ReviewCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->addColumn([
            // 1-n relationship
            'label' => "Отзывы", // Table column heading
            'type' => "select",
        ...
        $this->crud->addColumn([
            // 1-n relationship
            'label' => "Опубликованные", // Table column heading
            'type' => "check",
        ...
        $this->crud->addField([
            // 1-n relationship
            'label' => "Продукт", // Table column heading
            'type' => "select",
            'name' => 'product_id', // the column that contains the ID of that connected entity;
            'entity' => 'product', // the method that defines the relationship in your Model
            'attribute' => "title", // foreign key attribute that is shown to user
        ...
        $this->crud->addField([
            ...
            'label' => "Отзыв", // Table column heading
            'type' => "textarea",
        ...
        $this->crud->addField([
            ...
            'label' => "Опубликовать отзыв", // Table column heading
            'type' => "checkbox",
            'name' => 'status', // the column that contains the ID of that connected entity;
